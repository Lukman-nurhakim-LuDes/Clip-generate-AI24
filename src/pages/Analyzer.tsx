...
const mockClips = [
  { id: "1", thumbnail: "", duration: "45s", score: 94, subtitle: '"This is absolutely INSANE!"', startTime: "2:34", endTime: "3:19" },
  { id: "2", thumbnail: "", duration: "38s", score: 89, subtitle: '"No way, that actually worked?"', startTime: "5:12", endTime: "5:50" },
  { id: "3", thumbnail: "", duration: "52s", score: 87, subtitle: '"Let me show you something crazy..."', startTime: "8:45", endTime: "9:37" },
  { id: "4", thumbnail: "", duration: "41s", score: 82, subtitle: '"Wait, wait, wait..."', startTime: "12:20", endTime: "13:01" },
];
...
const Analyzer = () => {
  ...
  const [clips, setClips] = useState<typeof mockClips>([]);
